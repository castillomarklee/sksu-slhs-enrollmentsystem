 ...
 * @author castillo
 */
public class subjectjuniorview extends javax.swing.JInternalFrame {
        DBconnetion mycon = new DBconnetion();
    Connection conn;
    PreparedStatement pstmt;
    Statement stmt;
    ResultSet rs;
    public subjectjuniorview() {
        initComponents();
        mycon.doConnect();
        loadyearlevel();
        tablejunior();
    ...
    void loadyearlevel(){
        try {
            ...
            String junioryearlevel = "JUNIOR";
            rs = stmt.executeQuery("select studentyearlevel from yearlevel where studentcategory like'" + junioryearlevel.toUpperCase() + "%'");
...
"  subject\n" +
"WHERE \n" +
"  teachertable.teacher_id = subject.teacher_id and sub_category like'" + juniorquery.toUpperCase() + "%'");
